			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #ddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input type="number" class="form-control" id="userage" name="userage" maxlength="20" placeholder="나이를 입력하세요."></td>						
					</tr>
					<tr>
						...
						<td colspan="2">
							<div class="form-group" style="text-align: center; margin: 0 auto;">
								<div class="btn-group" data-toggle="buttons">
									...
									<label class="btn btn-primary active">
									<input type="radio" name="usergender" autocomplete="off" value="여">여
									</label>
								</div>
							</div>
						</td>						
					...
					<tr>
						...
						<td colspan="2"><input type="email" class="form-control" id="useremail" name="useremail" maxlength="20" placeholder="이메일을 입력하세요."></td>						
					</tr>
					<tr>
